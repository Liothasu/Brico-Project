 ...
 */
final class Version20231219233455 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F3ECD64BD FOREIGN KEY (original_message_id) REFERENCES message (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
